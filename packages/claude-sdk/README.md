...
It is published as part of [claude-cli](https://github.com/shellicar/claude-cli#readme) and is being rearchitected, so it is not yet meant for standalone use. See the [main documentation](https://github.com/shellicar/claude-cli#readme).
