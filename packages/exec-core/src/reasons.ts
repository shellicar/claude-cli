 ...
 * producer dies from signal 13 and reports 141 for real — rather than being killed with
 * SIGTERM and relabelled. The reason vocabulary lives here so the tool imports it from
