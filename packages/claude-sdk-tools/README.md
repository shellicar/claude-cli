...
It is published as part of [claude-cli](https://github.com/shellicar/claude-cli#readme) and is not really intended for standalone use. See the [main documentation](https://github.com/shellicar/claude-cli#readme).
