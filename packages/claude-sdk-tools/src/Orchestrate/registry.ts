...
export function createToolsV2Registry(deps: ToolsV2RegistryDeps): ToolsV2Registry {
  return new ToolsV2Registry([createFindToolV2(deps.fs), createPathsToolV2(deps.fs), createMatchToolV2(), createHeadToolV2(), createTailToolV2(), createRangeToolV2(), createReadToolV2(deps.fs), createProgramToolV2(deps.executor, deps.fs), createDeleteToolV2(deps.fs), createRefToolV2(deps.refStore), createCreateFileToolV2(deps.fs), createAppendFileToolV2(deps.fs)]);
}
