...
describe('renderStatus — content', () => {
  ...
  it('omits context when contextWindow is zero', () => {
    ...
    state.update({ type: 'message_usage', inputTokens: 1000, cacheCreationTokens: 0, cacheCreation5mTokens: 0, cacheCreation1hTokens: 0, cacheReadTokens: 0, outputTokens: 100, costUsd: 0.001, contextWindow: 0 });
    const expected = false;
