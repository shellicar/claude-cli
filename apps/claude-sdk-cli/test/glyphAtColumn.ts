 ...
 * points, so counting code points puts every later column out by the difference. A cell
 * carries the styling that travels with it, which is not part of what occupies the column.
 */
